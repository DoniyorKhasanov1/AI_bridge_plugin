...
class CodexToolWindowFactory : ToolWindowFactory {
    ...
    override fun createToolWindowContent(project: Project, toolWindow: ToolWindow) {
        ...
        fun updateChat(role: String, message: String, isThinking: Boolean = false) {
            ...
            val newMessage = """
                <div $idAttr style="margin-bottom: 12px; padding: 10px; background-color: #1a1a1a; border: 1px solid #2b2b2b;">
                    <b style="color: #888888; font-size: 10px;">$role</b>
                    <div style="margin-top: 5px; color: #dddddd;">${message.replace("\n", "<br>")}</div>
                </div>
            """.trimIndent()
